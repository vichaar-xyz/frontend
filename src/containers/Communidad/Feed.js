    ...
    return (
        <div>
            <div className='feed'>
                ...
                {/*EventPost*/}
                <div className='shortpost_content'>
                    <article className='shortpost_card'>
                        <header className='shortpost_header'>
                        ...
                        <div className='shortpost_content'>
                            <div className='shortpost_text_content'>
                                <p className='shortpost_text'>It serves as a central hub where users can discover, share, and discuss the latest insights, trends, and developments within the Web3 ecosystem.Key FeaturesPersonalized Feeds: Tailored to your interests, Connect3 delivers a personalized feed of articles, news, and updates relevant to the topics you care about most in the Web3 industry.Community Discussions: Engage in vibrant gasgvvv hshashajh ....<span className='shortpost_text_end'>see more</span> </p>

                            </div>

                        </div>
                        <footer className='shortpost_footer'>
